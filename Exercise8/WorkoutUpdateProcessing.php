				...
				<section id="main" class="container">
					...
					<div class="box">
						<?php
							...
							//echo "Great success!";
							$sql = "UPDATE workouts SET Date='$date' , BPweight='$bpweight', BPtime='$bptime', OPweight='$opweight', OPtime='$optime', Rweight='$rweight', Rtime='$rtime', PDweight='$pdweight', PDtime='$pdtime', Sweight='$sweight', Stime='$stime', Comment='$comment' Where ID='$ID'";
