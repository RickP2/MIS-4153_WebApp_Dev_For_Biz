				...
				<section id="main" class="container">
					...
					<div class="box">
						...
						<?php
							...
							//echo "Great success!";
							$sql = "SELECT * FROM workouts WHERE PirateID='$username'";
							...
							while($previousWorkout = mysqli_fetch_assoc($workoutArray)) {
								...
								echo "<td><a href='WorkoutUpdate.php?ID=" . $previousWorkout["ID"] ."'><img src='images/editIcon.png' width='20px'></a></td>";
								echo "<td><a href='WorkoutDelete.php?ID=" . $previousWorkout["ID"] ."'><img src='images/Delete-Button.svg' width='20px'></a></td>";
								echo "</tr>";
