...
<html>
	...
	<body class="homepage is-preload">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<section id="header">
					<div class="container">
						...
						<nav id="nav">
							<ul>
								<li><a class="icon solid fa-home" href="page3.php"><span>Page 4</span></a></li>
							</ul>
						</nav>
			...
			//echo "Great success!";
			$sql = "SELECT * FROM vendoraddresses WHERE Email='drakejo@ecu.edu'";
			...
			$curl = curl_init();
				...
				if ($err) {
					...
					//print_r($zip_info);
					while($zip_info = mysqli_fetch_assoc($result)) {
						echo "<tr>";
